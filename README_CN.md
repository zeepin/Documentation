...
Zeepin Chain采用GBFT－POS共识机制（星际共识），提供具备图灵完备性的虚拟机(WasmVM)作为智能合约的执行环境，为应用架构提供自定义脚步控制支持。支持Java、C#、Python、Javascript等编程语言开发的脚本，虚拟机可通过api与链进行集成交互。


目前Zeepin代码处于快速迭代开发、测试中，欢迎更多的开发者加入到zeepin技术社区中来！  
  
  
> 交易所接入指引
> * [EXCHANGE GUIDELINES](./Chinese/EXCHANGE_GUIDELINES_CN.md)
> * [JAVA SDK](./Chinese/JAVA_SDK_CN.md)
...
* [服务器部署](#服务器部署)
    * [选择网络](#选择网络)
        * [TestNet节点部署](#testnet节点部署)
        * [MainNet节点部署](#mainnet节点部署)
